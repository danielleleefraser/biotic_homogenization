Mega.beta.diversity<-function(PAtable,sites_ages,age_bins,latlongs,method=c("Sorensen","Jaccard","Forbes","Betadisper","DistDecay","Betamulti","Betapair"),calcmean=c("TRUE","FALSE")){
  library(vegan)
